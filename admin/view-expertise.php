            ...
            <div class="container-fluid">
                <div class="row page-title align-items-center">
                    <div class="col-sm-4 col-xl-6">
                        <h4 class="mb-1 mt-0">Expertise</h4>
                    </div>
                    <div class="col-sm-8 col-xl-6 d-flex justify-content-end">
                        <a href="add-expertise.php" class="d-flex align-items-center btn btn-primary">
                            <i class="uil-plus"></i>
                            <span class="ml-1">
                                Add Expertise
                            </span>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title mt-0 mb-1">View Expertise</h4>
                                <table
                                id="basic-datatable"
