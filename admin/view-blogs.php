            ...
            <div class="container-fluid">
                <div class="row page-title align-items-center">
                    ...
                    <div class="col-sm-8 col-xl-6 d-flex justify-content-end">
                        <a href="add-blog.php" class="d-flex align-item-center btn btn-primary">
                            <i class="uil-plus"></i>
                            <span class="ml-1">
                                Add Blog
                            </span>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title mt-0 mb-1">View Blogs</h4>
                                <table
                                id="basic-datatable"
                                ...
                                <tbody>
                                    <tr>
                                    <td>1</td>
                                    <td>Maximizing the use of PCs</td>
                                    <td>Lorem oppa na gome</td>
                                    <td>Laplace Domand</td>
