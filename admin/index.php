...
<body class="account-pages">
    ...
    <div class="wrapper-page account-page-full d-flex align-items-center">
                ...
                <div class="account-box">
                    ...
                    <div class="card-box shadow-none p-4">
                        <div class="p-2">
                            ...
                            <p class="text-muted text-center">Sign in to continue to ZealaraxHQ.</p>

                            <form class="mt-4" action="dashboard.php">
